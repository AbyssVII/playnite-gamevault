...
namespace GameVault
{
    ...
    public static class L10n
    {
        ...
        private static readonly Dictionary<string, string> Chinese = new Dictionary<string, string>
        {
            ...
            { "LocShareTop10Total", "总时长 Top 10：" },
            { "LocShareTop10Recent","近两周时长 Top 10：" },
            { "LocShareTop10Score", "Metacritic 评分 Top 10：" },
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "LocShareTop10Total", "Top 10 by total time:" },
            { "LocShareTop10Recent","Top 10 by recent playtime:" },
            { "LocShareTop10Score", "Top 10 by Metacritic score:" },
